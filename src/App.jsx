      ...
      <div className="flex flex-grow items-center justify-center bg-gray-900 h-full">
        ...
        c0.232,0,3.786-3.782,3.786-3.782l2.227,2.229c0,0-3.785,3.523-3.785,3.787C16.207,14.239,19.992,17.769,19.992,17.769z"
          ...
          <div className="flex items-center w-full mt-2">
            ...
            {/* submit button[e] */}
            {/* todo input[s] */}
            <input className="peer/todo flex-grow h-8 ml-4 bg-transparent focus:outline-none font-medium" type="text" id="todo" name="todo" required placeholder="add a new todo" ref={ref} onKeyUp={onKeyUp} />
            {/* todo input[e] */}
            {/* reset button[s] */}
